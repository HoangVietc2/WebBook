      ...
      let html = `  <tr>
                        ...
                        <td>
                            <div class="flex align-items-center list-user-action">
                              <button type="button" class="btn btn-sm btn-warning mx-1 px-1 py-1" data-toggle="modal" data-target="#update-user" onclick="getBYID(${value.id_user})">
    ...
    .done(function (response) {
      ...
      if (data && response.length > 0) {
        ...
        response.forEach(function (value) {
          $("#id_username-up").val(value.id_user);
