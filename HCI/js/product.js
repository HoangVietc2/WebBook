// Load initial data
const id_category = new URLSearchParams(window.location.search).get(
  "categoryId"
);
                                    ...
                                    <div class="iq-card-body p-0">
                                       <div class="d-flex align-items-center">
                                          <div class="col-6 p-0 position-relative image-overlap-shadow">
                                             <a href="javascript:void();"><img class="img-fluid rounded w-100" src="https://lh3.googleusercontent.com/d/${value.img}" alt=""></a>
                                             <div class="view-book">
